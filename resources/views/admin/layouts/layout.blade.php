...
<head>
    ...
    <title>{{ $settings ? $settings->site_name : "ImageFaculty" }} | Admin Panel</title>
    ...
    <div class="navbar navbar-expand-md navbar-dark d-flex align-items-center flex-row" style="padding:12px 15px;">
        ...
        @else
            <div class="text-white">
                ...
                <span class="p-0 h4 m-0">FACULITY</span>
            </div>
        @endisset
        <div class="d-md-none">
            ...
            <div class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="navbar-collapse collapse" id="navbar-footer">
                    <span class="navbar-text">
                        &copy; 2020 {{ $settings ? $settings->site_name : "Image Faculity" }}
                    </span>
                </div>
            </div>
        </div>
