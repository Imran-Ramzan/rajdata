                ...
                <form action="{{ route('types.update',$type->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div style="display:block;">
                            ...
                            <button type="button" id="header" class="btn btn-primary btn-md trigger-image-utility" data-content="{{$headerImages}}" data-target="header-image" data-postid="{{$type->id}}"  data-class="App\Type">Update Header Image</button>
